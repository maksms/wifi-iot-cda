...
---------------------------------------------------------------------
cfgdes[0] - управление подсветкой экрана, 0 - ручное, 1 - авто по adc, 2 - по расписанию
valdes[1] 
---------------------------------------------------------------------
cfgdes[1] - время отображения доп. экранов, сек, если 0 - не отображать
valdes[2]
---------------------------------------------------------------------
cfgdes[2] - бегущие доп. экраны? 0 - нет, 1 - да
valdes[3]
---------------------------------------------------------------------
cfgdes[3] - скорость бегущих экранов
valdes[4]
---------------------------------------------------------------------
cfgdes[4] - эффект на экране часов
valdes[5]   0 - нет, 
