...
void hsv_to_rgb(volatile color_rgb_t *rgb, const color_hsv_t hsv) {
	...
	switch ( hi ) {
		case 0: h_pr = hsv.h;       break;
		case 1: h_pr = hsv.h - 60;  break;
		case 2: h_pr = hsv.h - 120; break;
		case 3: h_pr = hsv.h - 180; break;
		case 4: h_pr = hsv.h - 240; break;
		case 5: h_pr = hsv.h - 300; break;
	}
