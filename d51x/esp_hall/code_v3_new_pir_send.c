...
// TODO: 
// при движении плавно включать ленту
// опция настройки - либо лента, либо лампа при движении
// опция настройки - либо лента, либо лампа при открытии двери (если нет движения, то гасить лампу???)
// уровень яркости ленты в ночном режиме
