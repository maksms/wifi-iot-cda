...
// Отсечка счетчика, Время работы общее, Время работы сегодня, Расход общий, Расход сегодня
...
#define ADDLISTSENS {200,LSENSFL0,"FuelPump",FUEL_PUMP,&fuel_pump_state,NULL}, \
					...
					{203,LSENSFL0|LSENS32BIT,"WorkTimeTotal","fuelpump_total",&fuel_pump_working_time,NULL}, \
					{204,LSENSFL0|LSENS32BIT,"WorkTimeDay","fuelpump_day",&fuel_pump_today_time,NULL}, \
					{205,LSENSFL0,"OnCount","oncnt",&on_cnt,NULL}, \
					{206,LSENSFL0|LSENS32BIT,"OnDuration","ondur",&prev_duration,NULL}, 
...
void webfunc(char *pbuf) 
{
	...
	uint32_t today_sec = fuel_pump_today_time % 60;
	uint32_t today_min = fuel_pump_today_time / 60;
	uint32_t today_hour = today_min / 60;
	today_min = today_min % 60;
	...
	os_sprintf(HTTPBUFF, 	"<tr align='center'>"
							...
							"</tr>"
							, today_hour, today_min, today_sec
